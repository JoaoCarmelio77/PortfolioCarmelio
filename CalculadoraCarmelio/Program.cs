...
namespace Calculadora_Basica
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Digite o primeiro valor, em seguida pressione a tecla ENTER: ");
            ...
            Console.WriteLine("Digite a operação matemática desejada: ( /= divisão , * = multiplicação, + = soma, - = subtração e % = MOD resto ) e pre: ");
